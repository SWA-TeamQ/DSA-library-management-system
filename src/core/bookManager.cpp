...
// Sort a books by its title in ascending order
void bookManager::sortBooksByTitleAsc()
{
...
// Sort a books by its title in descending order
void bookManager::sortBooksByTitleDesc()
{
    mergeSort(bookList, [](const Book &a, const Book &b)
              { return a.getTitle() > b.getTitle(); });
...
void bookManager::sortBooksByYearAsc()
{
    mergeSort(bookList, [](const Book &a, const Book &b)
